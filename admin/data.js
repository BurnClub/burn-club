...
const EXERCISE_LIBRARY = [
  ...
  { id: "cat-cow-stretch", name: "Cat-Cow Stretch", bodyParts: ["Low Back", "Core"], modality: "Stretch", equipment: ["Bodyweight"], technique: "", trackWeight: false, videoUrl: "" },
  { id: "childs-pose", name: "Child's Pose", bodyParts: ["Low Back", "Glutes"], modality: "Stretch", equipment: ["Bodyweight"], technique: "", trackWeight: false, videoUrl: "" },
  { id: "hip-flexor-stretch", name: "Hip Flexor Stretch", bodyParts: ["Hip Flexors", "Quads"], modality: "Stretch", equipment: ["Bodyweight"], technique: "", trackWeight: false, videoUrl: "" },
  { id: "shoulder-and-chest-opener", name: "Shoulder & Chest Opener", bodyParts: ["Chest", "Shoulders"], modality: "Stretch", equipment: ["Bodyweight"], technique: "", trackWeight: false, videoUrl: "" },
  { id: "standing-hamstring-stretch", name: "Standing Hamstring Stretch", bodyParts: ["Hamstrings"], modality: "Stretch", equipment: ["Bodyweight"], technique: "", trackWeight: false, videoUrl: "" },
];
